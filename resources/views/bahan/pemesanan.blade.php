      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form_container">
            ...
            <form action="{{route('nonpromo.store')}}" method="post">
              @csrf
              <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control @error('id_paket') is-invalid @enderror" id="exampleInputid_paket" placeholder="Nama Paket" name="id_paket" value="{{$paket->id}}" readonly>
